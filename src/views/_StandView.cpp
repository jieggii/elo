...
//     this->display->displayIcon(ICON_PERSON_STAND_SLOT, 0, 0);
//     this->display->displayIcon(ICON_TABLE_STAND_SLOT, 1, 0);
//     this->display->displayIcon(ICON_ENV_OPTIMAL_SLOT, 15, 0);
//
...
//         this->viewNavigator->navigateTo(IDLE_VIEW_INDEX);
//     }
...
//               .postureReminderTimer = Timer((uint32_t)operationalConfig->standMode.postureReminder.interval *
//               1000)}),

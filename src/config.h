...
void initDefaultOperationalConfig(OperationalConfig* config) {
    config->environment = OperationalConfig::Environment{
        .temperature = OperationalConfig::Environment::Temperature{
        ...
        .humidity = OperationalConfig::Environment::Humidity{
        ...
        .co2 = OperationalConfig::Environment::CO2{
            .max_optimal = 850,
            .max_acceptable = 950,
        },
    };
    ...
    config->sitMode = OperationalConfig::Mode{
        .enabled = true,
        .duration = 25 * 60,
        .exerciseBreak = OperationalConfig::Mode::ExerciseBreak{
            .enabled = true,
            .duration = 4 * 60,
            .interval = 30 * 60,
        },
        .postureReminder = OperationalConfig::Mode::PostureReminder{
            .enabled = true,
            .interval = 60 * 3,
        },
    };
